...
TEST_F(KernelTest,kernelCached) {
    testGaussianCached(kernel,"gaussianKernelTestX",
    		"gaussianKernelTestResult",0.002);
    testGaussianCached(kernelDouble,"gaussianKernelTestX",
    		"gaussianKernelTestResult",10e-10);
}
